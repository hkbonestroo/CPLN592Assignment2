...
We evaluated the predictive power of different combinations of variables by first dividing homes with known sale values into a "Training" set and a "Test" set. 60% of homes 
