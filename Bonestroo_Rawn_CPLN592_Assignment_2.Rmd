...
plot2<-ggplot(data=Miami_test_plot, aes(lagPriceError,SalePrice.Error)) +
  ...
  labs(title="Error as a function of the spatial lag of error", x="Spatial lag of errors (mean error of five nearest neighbors)", y="Sale Price Error",  
...
plot1 <-ggplot(data=Miami_test_plot, aes(lagPrice,SalePrice)) +
  geom_point()+
  geom_smooth(method=lm, se=FALSE)+
  labs(title="Price as a function of the spatial lag of price", x="Spatial lag of price (mean of five nearest neighbors)", y="Sale Price",  
...
```{r Moran,results='hide', echo=FALSE, error=FALSE, message=FALSE, warning=FALSE,.asp=1}
...
```{r Predicted Maps,echo=FALSE, results='hide',error=FALSE, message=FALSE, warning=FALSE,fig.asp=1}
