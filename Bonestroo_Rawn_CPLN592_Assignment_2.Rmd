...
```{r Miami Maps, results='hide', error=FALSE, message=FALSE, warning=FALSE,fig.asp=.75}
...
The output of a regression model using the training set data and including our final variable selection of Neighborhood, nearby Sale Price Average, Zoning, and presence of a Dock is summarized below.
